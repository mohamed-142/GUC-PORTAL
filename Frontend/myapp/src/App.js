...
<Route path="/hod*" exact component={Nav} />
     ...
     <Route path =  '/hod/' exact component = {hod}/>
      ...
      <Route path =  '/hod/viewStaffperCourse' exact component = {StaffperCourseHod}/>;
      <Route path =  '/hod/viewCoverage' exact component = {CoursesCoverage}/>;
      <Route path =  '/hod/TeachingAssignments' exact component = {TeachingAssignments}/>;
      ...
      <Route path="/instructor" exact component={myprofile} />
          ...
          <Route path="/instructor/myslotspercourse" exact component={Myslotspercourse} />
          <Route path="/instructor/assignstafftoslot" exact component={Assignstafftoslot} />
          <Route path="/instructor/updatestaffslot" exact component={Updatestaffslot} />
          <Route path="/instructor/updatestafffromcourse" exact component={Updatestafffromcourse} />
          <Route path="/instructor/deletestafffromslot" exact component={Deletestafffromslot} />
          <Route path="/instructor/removestafffromcourse" exact component={Removestafffromcourse} />
          <Route path="/instructor/assigncoordinatortocourse" exact component={Assigncoordinatortocourse} />
          <Route path="/instructor/viewStaff" exact component={Viewstaff} />
          <Route path="/instructor/staffpercourse" exact component={StaffpercourseInstructor} />
          ...
          <Route path='/academic/viewStaffDayOff' exact component={DayOffAcademic} />
          <Route path='/academic/viewStaffperCourse/:name' exact component={StaffperCourseAcademic} />
          <Route path="/academic/viewshedule" exact component={Viewschedule} />
          <Route path="/academic/replacementrequests" exact component={Replacementrequest} />
          <Route path="/academic/slotlinkingrequests" exact component={slotlinkingrequest} />
          ...
          <Route path="/academic/Viewallrequests" exact component={Viewallrequests} />
          <Route path="/academic/Viewacceptedrequests" exact component={Viewacceptedrequests} />
          <Route path="/academic/Viewrejectedrequests" exact component={Viewrejectedrequests} />
          <Route path="/academic/Viewpendingrequests" exact component={Viewpendingrequests} />
