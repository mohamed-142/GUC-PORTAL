...
export default class AddRecord extends Component {
    ...
    componentDidMount() { 
      axios.get('http://localhost:1000/hr/member',{headers: {'token':localStorage.getItem("token")}})
      .then(response => {
    ...
    onSubmit(e) {
      ...
      axios.post('http://localhost:1000/hr/log', body,{headers: {'token':localStorage.getItem("token")}})
