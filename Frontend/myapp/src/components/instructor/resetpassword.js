                                        ...
                                        <form id="register-form" onSubmit={doSomething}>
                                            ...
                                            <div className="form-group">
                                                <div className="emailIcon input-group">
                                                    <span className="icon input-group-addon"><i className="fas fa-envelope fa-3x" aria-hidden="true"></i></span>
                                            ...
                                            <div className="buttonIcon form-group">
                                                <input name="recover-submit" className="btn btn-md btn-primary btn-block rounded" value="Reset Password" type="submit"></input>
                                            </div>
