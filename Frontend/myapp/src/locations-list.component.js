...
const Location = props => (
  <tr>
    ...
    <td>
      <Link to={"/edit/"+props.location._id}>edit</Link> | <a href="#" onClick={() => { props.deleteLocation(props.location.room) }}>delete</a>
    </td>
  </tr>
)
...
export default class LocationsList extends Component {
  ...
  componentDidMount() { 
    axios.get('http://localhost:1000/location/',config)
      .then(response => {
  ...
  deleteLocation(room) {
    axios.delete('http://localhost:1000/hr/location/'+room)
