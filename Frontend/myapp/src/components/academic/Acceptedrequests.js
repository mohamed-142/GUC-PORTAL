    ...
    useEffect(()=>{
      ...
      return (
          <div className = "mainreq">
              ...
              className = "w3-table-all w3-centered" responsive striped bordered hover variant="dark">
    <thead>
      <tr>
        <th>#</th>
        <th>status</th>
